...
def get_args():
    ...
    parser.add_argument('--size', default=(480, 320), help='size of original frame', type=tuple)
    # parser.add_argument('--size', default=(416, 320), help='size of original frame', type=tuple)
